...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 10 jan. 2026 à 02:54
...
(2, 3, 'Stephane', 'siamois', 2, 'male', '2023-12-12', 3, 'chat'),
(3, 4, 'QUEEN E', 'Dobermann', 3, 'Femelle', '2026-01-09', 3, 'chien'),
(4, 0, 'Dobermann', '2', 0, '2023-06-14', '0000-00-00', 0, '4'),
(5, 0, 'Dobermann', '2', 0, '2023-06-14', '0000-00-00', 0, '4'),
(6, 0, 'Dobermann', '2', 0, '2023-06-14', '0000-00-00', 0, '4'),
(7, 0, 'Dobermann', '2', 0, '2023-06-14', '0000-00-00', 0, '4'),
(8, 0, 'Dobermann', '2', 0, '2023-06-14', '0000-00-00', 0, '4'),
(9, 0, 'Dobermann', '2', 0, '2023-06-14', '0000-00-00', 0, '4'),
(10, 0, 'Dobermann', '2', 0, '2023-06-14', '0000-00-00', 0, '4'),
(11, 0, 'Dobermann', '2', 0, '2023-06-14', '0000-00-00', 0, '4'),
(12, 4, 'knjn', ',kl', 5, 'Femelle', '2026-01-09', 44, 'chat');
...
CREATE TABLE IF NOT EXISTS `ingredient` (
  ...
  `image_ingredient` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
INSERT INTO `ingredient` (`id_ingredient`, `nom_ingredient`, `image_ingredient`) VALUES
(4, 'Riz', NULL),
(5, 'Poulet', NULL),
(6, 'Carrottes', NULL),
(7, 'Huile de colza', NULL),
(8, 'Compléments minéreau', NULL),
(9, 'Levure de bière', NULL),
(10, 'Saumon', NULL),
(11, 'Riz brun', NULL),
(12, 'Yaourt', NULL),
(13, 'Épinard cuit', NULL),
(14, 'Brin de persil', NULL),
(15, 'Huile d\'olive', NULL),
(16, 'Steack haché', NULL),
(17, 'Haricots verts', NULL),
(18, 'Riz soufflé', NULL),
(19, 'Huile de saumon', NULL),
(20, 'Blanc de poulet', NULL),
(21, 'Courgettes', NULL),
(22, 'Jus de cuisson de po', NULL),
(23, 'Poulet deossé', NULL),
(24, 'Foie de volaille', NULL),
(25, 'Potiron', NULL),
(26, 'Farine complète', NULL),
(27, 'Pomme', NULL),
(28, 'Oeuf', NULL),
(29, 'Canelle en poudre', NULL),
(30, 'Beurre de cacahuète', NULL),
(31, 'Myrtilles', NULL),
(32, 'Patate douce', NULL),
(33, 'Flocons d\'avoine', NULL),
(34, 'Fromage blanc', NULL),
(35, 'Jus d\'une boite de t', NULL),
(36, 'Eau', NULL),
(37, 'Herbe à chat', NULL),
(38, 'Fraise', NULL),
(39, 'Noix de coco rapé', NULL),
(40, 'Banane mûre', NULL),
(41, 'Farine d\'avoine', NULL),
(42, 'Levure chimique', NULL),
(43, 'Thon', NULL),
(44, 'Lait spécial chat', NULL),
(45, 'Farine', NULL),
(46, 'Huile de saumon', NULL),
(47, 'Pâte à friandise liq', NULL),
(48, 'Petites friandises', NULL),
(49, 'Boite de thon', NULL),
(50, 'Tranche jambon', NULL);
...
INSERT INTO `ingredient_recette` (`fk_recette`, `fk_ingredient`, `quantite`) VALUES
(7, 4, '50g'),
(7, 5, '150g'),
(7, 6, '50g'),
(7, 7, '1 cuillère à soupe'),
(7, 8, '1mesurre'),
(7, 9, '1 cuillère à soupe'),
(8, 10, '130g'),
(8, 11, '80g'),
(8, 12, '40g'),
(8, 13, '150g'),
(8, 14, NULL),
(8, 15, '1 cuillère à soupe'),
(10, 16, '1'),
(9, 6, '70g'),
(9, 17, '20g'),
(9, 18, '20g'),
(9, 19, '1 cuillère à soupe'),
(12, 20, '100g'),
(12, 21, '20g'),
(12, 7, '1 cuillère à café'),
(12, 9, 'Une pincée'),
(11, 10, '80g'),
(11, 4, '20g'),
(11, 22, '1 cuillère à soupe'),
(10, 23, '100g'),
(10, 24, '30g'),
(10, 25, '30g'),
(16, 26, '150g'),
...
(16, 29, 'Une pincée'),
(18, 12, '1 pot'),
(18, 30, '2 cuillère à soupe'),
(18, 31, 'quelques'),
(17, 32, '1'),
(17, 33, '100g'),
(17, 34, '2 cuillère à soupe'),
(17, 9, '1/2 cuillère'),
(17, 20, '1 petit morceau'),
(5, 35, ''),
(5, 36, '50ml'),
(5, 37, 'une pincée'),
(6, 38, '2'),
(6, 12, '1 '),
(19, 12, '3 cuillère à soupe'),
(19, 38, '2-3'),
(19, 39, 'une pincée'),
(14, 49, '1'),
(14, 36, ''),
